...
<div class="container">
    ...
    <h1>Receipt of Purchase <span>LOGO HERE</span></h1>
...
if (isset($_GET['p_id'])) {
    ...
    $s = "Select * from purchasemaster where PurchaseID = '$p_id'";
    $s = $conn->query($s);
    $s = $s->fetch_assoc();


    $sql = "SELECT * FROM purchasedetail WHERE PurchaseID = '$p_id'";
    ...
    <div class="receipt_body">
        ...
        <div class="date_time_con">
            <div class="date"><?php echo $s['PurchaseDate'];?></div>
        </div>
